#
# Manifiesto del módulo 'Modulo062'
#
# Generado por Juan Angel Facundo Lopez, Jose Luis Razon Leyva,Jesus Alexanddro Cervanntes Hernandez 
#
# Generado el 18/08/2021
#

@{

# Módulo de script o archivo de módulo binario asociado con este manifiesto.
RootModule = 'Modulo062.psm1'
...
GUID = 'e3bf9acd-6dad-41e8-b2dc-e3ece6de6e12'
...
Copyright = '(c) 2021 Juan Facundo. Todos los derechos reservados.'

# Descripción de la funcionalidad proporcionada por este módulo.
Description = 'Elaborado en Equipo'
